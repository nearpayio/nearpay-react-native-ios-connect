...
var _reactNativeNearpayConnectCore = _interopRequireDefault(require("react-native-nearpay-connect-core"));
...
class NearpayConnect {
  constructor() {
    this.core = _reactNativeNearpayConnectCore.default;
  ...
  onError(callback) {
    this.emitter.addListener('onError', _NearpayEventEmitter.EventType.terminal, result => {
      try {
